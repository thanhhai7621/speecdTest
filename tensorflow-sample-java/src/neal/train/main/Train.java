...
//      System.exit(1);
//    }
    final byte[] graphDef = Files.readAllBytes(Paths.get("E:/WorkSpace/tensorflow-sample-java/graph.pb"));
    final String checkpointDir = "E:/WorkSpace/tensorflow-sample-java/checkpoint";
  ...
  public static void printPredictionsOnTestSet(Session sess) {
    final float[][][] inputBatch = new float[][][] {{{2.0f}},{{1.0f}},{{0.0f}},{{99.0f}},{{800000.0f}}};
  ...
  public static void fillNextBatchForTraining(float[][][] inputs, float[][][] targets) {
    ...
    for (int i = 0; i < inputs.length; ++i) {
      ...
      targets[i][0][0] = inputs[i][0][0] + 4.0f;
    }
  }
}